    ...
    child: const Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(color: Color(0xFF1E6370), fontSize: 13),
        ),
      ],
    ),
  ),
  ListTile(
    leading: const Icon(Icons.home_outlined, color: Color(0xFF1E6370)),
    title: const Text('Home', style: TextStyle(color: Color(0xFF1E6370))),
    onTap: () => _go(context, '/'),
  ),
  ListTile(
    leading: const Icon(Icons.psychology_outlined, color: Color(0xFF1E6370)),
    title: const Text('Servizi', style: TextStyle(color: Color(0xFF1E6370))),
    onTap: () => _go(context, '/servizi'),
  ),
  ListTile(
    leading: const Icon(Icons.article_outlined, color: Color(0xFF1E6370)),
    title: const Text('I miei articoli', style: TextStyle(color: Color(0xFF1E6370))),
