...
class _ArticoloFormState extends State<_ArticoloForm> {
  ...
  Future<void> _save() async {
    ...
    // Preserve original publish date on edit; stamp now on new articles.
    final existing = widget.articolo;
    final now = DateTime.now();
    final dataStr = existing != null
        ? existing.dataPubblicazione
    ...
    final companion = ArticoliCompanion(
      ...
      pubblicatoAt: existing != null
          ? Value(existing.pubblicatoAt ?? now)
          : Value(now),
